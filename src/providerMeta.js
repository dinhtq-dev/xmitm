 ...
 *
 * TẠM THỜI: chỉ bật gemini-cli (Google Gemini Web OAuth).
 * Các provider khác đã comment — bỏ comment khi cần bật lại.
 */
const PROVIDER_META = {
  // openai: {
  ...
  "gemini-cli": {
    ...
    icon: "✨",
    desc: "Gemini CLI API — cloudcode-pa.googleapis.com + retrieveUserQuota",
